...
State.prototype = MACROUTILS.objectLibraryClass( MACROUTILS.objectInherit( Object.prototype ), 'osg', 'State' );


State.prototype.getCacheUniformsApplyRenderLeaf = function () {
    return this._programCommonUniformsCache;
};

State.prototype.setGraphicContext = function ( graphicContext ) {
    this._graphicContext = graphicContext;
};

State.prototype.getGraphicContext = function () {
    return this._graphicContext;
};

State.prototype.getShaderGeneratorProxy = function () {
    return this._shaderGeneratorProxy;
};

State.prototype.pushCheckOverride = function ( stack, object, maskValue ) {
...
State.prototype.pushStateSet = function ( stateset ) {
    this._statsPushStateSetCount++;
...
State.prototype.getStateSetStackSize = function () {
    return this.stateSets.values().length;
};

State.prototype.insertStateSet = ( function () {
    var tmpStack = [];
...
State.prototype.removeStateSet = ( function () {
    var tmpStack = [];
...
State.prototype.resetCacheFrame = function () {
    ...
    this._statsPushStateSetCount = 0;
};


// apply program if needed
State.prototype.applyProgram = function ( program ) {
    if ( this._program === program ) return;
    this._program = program;
    this.getGraphicContext().useProgram( program );
};

State.prototype.applyModelViewMatrix = ( function () {
...
State.prototype.applyProjectionMatrix = function ( matrix ) {
...
State.prototype.applyStateSet = function ( stateset ) {
    this.pushStateSet( stateset );
    this.apply();
    this.popStateSet();
};

State.prototype.getStateSetStackHash = function () {
...
State.prototype.popAllStateSets = function () {
    while ( this.stateSets.values().length ) {
        this.popStateSet();
    }
};

State.prototype.popStateSet = function () {
    this._popStateSetCount++;
...
State.prototype.haveAppliedAttribute = function ( attribute ) {
...
State.prototype.applyAttribute = function ( attribute ) {
...
State.prototype.applyTextureAttribute = function ( unit, attribute ) {
...
State.prototype.getLastProgramApplied = function () {
    return this.attributeMap.Program.lastApplied;
};

State.prototype.applyDefault = function () {
...
State.prototype.applyAttributeMap = function ( attributeMap ) {
...
State.prototype.getObjectPair = function ( object, value ) {
    return {
        object: object,
        value: value
    };
...
State.prototype.pushUniformsList = function ( uniformMap, stateSetUniformMap ) {
...
State.prototype.popUniformsList = function ( uniformMap, stateSetUniformMap ) {
...
State.prototype._applyTextureAttributeStack = function ( gl, textureUnit, attributeStack ) {
...
State.prototype.applyTextureAttributeMapList = function ( textureAttributesMapList ) {
...
State.prototype.setGlobalDefaultValue = function ( attribute ) {
...
State.prototype.setGlobalDefaultAttribute = function ( attribute ) {
...
State.prototype.getGlobalDefaultAttribute = function ( typeMember ) {
    var attributeMap = this.attributeMap;
...
State.prototype.setGlobalDefaultTextureAttribute = function ( unit, attribute ) {
...
State.prototype.getGlobalDefaultTextureAttribute = function ( unit, typeMember ) {
    var attributeMap = this.getOrCreateTextureAttributeMap( unit );
    var as = attributeMap[ typeMember ];
    return as.globalDefault;
};

State.prototype.getOrCreateTextureAttributeMap = function ( unit ) {
    if ( !this.textureAttributeMapList[ unit ] ) this.textureAttributeMapList[ unit ] = new Map();
    return this.textureAttributeMapList[ unit ];
};

State.prototype.pushAttributeMap = function ( attributeMap, stateSetAttributeMap ) {
    /*jshint bitwise: false */
    var attributeStack;
...
State.prototype.popAttributeMap = function ( attributeMap, stateSetAttributeMap ) {
...
State.prototype.setIndexArray = function ( array ) {
    var gl = this._graphicContext;
...
State.prototype.lazyDisablingOfVertexAttributes = function () {
...
State.prototype.applyDisablingOfVertexAttributes = function () {
    var keys = this.vertexAttribMap._keys;
    for ( var i = 0, l = keys.length; i < l; i++ ) {
...
State.prototype.setVertexAttribArray = function ( attrib, array, normalize ) {
...
State.prototype._getActiveUniformsFromProgramAttributes = function ( program, activeUniformsList ) {
...
State.prototype._getActiveUniformsFromProgramTextureAttributes = function ( program, activeUniformsList ) {
...
State.prototype._cacheUniformsForCustomProgram = function ( program, activeUniformsList ) {
...
State.prototype._applyCustomProgramUniforms = ( function () {
...
State.prototype._generateAndApplyProgram = function () {
...
State.prototype._computeForeignUniforms = function ( programUniformMap, activeUniformMap ) {
...
State.prototype._removeUniformsNotRequiredByProgram = function ( activeUniformMap, programUniformMap ) {
...
State.prototype._cacheUniformsForGeneratedProgram = function ( program ) {
...
State.prototype._applyGeneratedProgramUniforms = function ( program ) {
